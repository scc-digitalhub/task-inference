...
"""Example: zero-shot object detection with the ONNX Runtime backend.
...
def main() -> None:
    args = sys.argv[1:]
    model_name: str | None = "./onnx/owlvit/"
    if "--model" in args:
    ...
    task = create_task("onnxruntime", "zero-shot-object-detection", model_name=model_name)
